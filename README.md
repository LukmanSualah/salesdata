...
A publishable end-to-end retail sales project built with **Excel, SQL, and Power BI**. All records are synthetic.

## Business question
Which products, regions, and months drive sales and profit, and where should leaders protect margin?

## Tools used
- **Excel:** data table, formula-ready monthly summary, and native-chart dashboard
- **SQL:** data quality checks and business KPI queries
- **Power BI:** data model, DAX measures, and dashboard layout instructions
...
- Central is the top region by sales.
- 2025 generated **$360,723** in sales.

## Repository structure
`data/` raw CSV for SQL and Power BI import  
`Sales_Analytics_Excel_Dashboard.xlsx` Excel dashboard and source table  
